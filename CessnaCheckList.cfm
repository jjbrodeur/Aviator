...
<CFSCRIPT>
    this.PageName = "CessnaChecklist.cfm";
    this.PlanId = 0;
    this.FlightId = 0;
   ...
   this.flActiveRunway = 30;
    ...
    this.flTBINextService = 0;
    this.flTBILastService = 0;
    this.flTBIRecentHours = 0;
    this.flTBI = 0;
   ...
   <CFQUERY NAME="PlanUpdate" DATASOURCE="#Application.DSN#">
      ...
      <CFIF this.PlanId GT 0>  
       UPDATE 
          dbo.tblFlightPlan 
       SET
          DepartDateTime = '#DateFormat(now(),"YYYY-MM-DD")# #form.flDepartureHH#:#form.flDepartureMM#:00'
...
function fnStartupFocus() {
   fnAllHide();
   fnStartupShow();
}

function fnATISFocus() {
   fnAllHide();
   fnATISShow();
}

function fnDepartFocus() {
   fnAllHide();
   fnDepartShow();
}

function fnTakeOffFocus() {
   fnAllHide();
   fnTakeOffShow();
}

function fnCruiseFocus() {
   fnAllHide();
   fnCruiseShow();
}

function fnArriveFocus() {
   fnAllHide();
   fnArriveShow();
}

function fnCircuitFocus() {
   fnAllHide();
   fnCircuitShow();
}

function fnWeightFocus() {
   fnAllHide();
   fnWeightShow();
}

function fnBriefFocus() {
   fnAllHide();
   fnBriefShow();
}

function fnSpeedsFocus() {
   fnAllHide();
   fnSpeedsShow();
}
...
function fnStartupShow() {
    oBlock = document.getElementById("DivStartup");   
    oBlock.style.display = "block";
}
function fnStartupHide() {
    oBlock = document.getElementById("DivStartup");   
    oBlock.style.display = "none";
}

function fnATISShow() {
    oBlock = document.getElementById("DivATIS");   
    oBlock.style.display = "block";
}
function fnATISHide() {
    oBlock = document.getElementById("DivATIS");   
...
function fnTakeOffShow() {
    oBlock = document.getElementById("DivTakeOff");   
    oBlock.style.display = "block";
}
function fnTakeOffHide() {
    oBlock = document.getElementById("DivTakeOff");   
    oBlock.style.display = "none";
}


function fnCruiseShow() {
    oBlock = document.getElementById("DivCruise");   
    oBlock.style.display = "block";
}
function fnCruiseHide() {
    oBlock = document.getElementById("DivCruise");   
    oBlock.style.display = "none";
}

function fnDepartShow() {
    oBlock = document.getElementById("DivDepart");   
    oBlock.style.display = "block";
}
function fnDepartHide() {
    oBlock = document.getElementById("DivDepart");   
    oBlock.style.display = "none";
}

function fnArriveShow() {
    oBlock = document.getElementById("DivArrive");   
    oBlock.style.display = "block";
}
function fnArriveHide() {
    oBlock = document.getElementById("DivArrive");   
    oBlock.style.display = "none";
}

function fnWeightShow() {
    oBlock = document.getElementById("DivWeight");   
    oBlock.style.display = "block";
}
function fnWeightHide() {
    oBlock = document.getElementById("DivWeight");   
    oBlock.style.display = "none";
}

function fnCircuitShow() {
    oBlock = document.getElementById("DivCircuit");   
    oBlock.style.display = "block";
}
function fnCircuitHide() {
    oBlock = document.getElementById("DivCircuit");   
    oBlock.style.display = "none";
}


function fnBriefShow() {
    oBlock = document.getElementById("DivBrief");   
    oBlock.style.display = "block";
}
function fnBriefHide() {
    oBlock = document.getElementById("DivBrief");   
    oBlock.style.display = "none";
}

function fnSpeedsShow() {
    oBlock = document.getElementById("DivSpeeds");   
    oBlock.style.display = "block";
}
function fnSpeedsHide() {
    oBlock = document.getElementById("DivSpeeds");   
    oBlock.style.display = "none";
}
...
<HEAD>
	...
	<TITLE>C172M, C152 Procedures</TITLE>
</HEAD>

<BODY OnLoad="showClock();" BGCOLOR="##EEEEEE">
...
<TR><TD ALIGN=CENTER>
<INPUT TYPE="BUTTON" NAME="btnAllShow" VALUE=" ALL " OnClick="fnAllShow();" Style="text-align: center; background-color: BLACK; COLOR: white; font-size: 72">
<INPUT TYPE="BUTTON" NAME="btnDepart1" VALUE="Depart &uarr;" OnClick="fnDepartFocus();"  Style="font-size: 72 " >
<INPUT TYPE="BUTTON" NAME="btnArrive" VALUE="Arrive &darr;" OnClick="fnArriveFocus();" Style="font-size: 72 " >
<INPUT TYPE="SUBMIT" NAME="btnSave" VALUE=" Save " STYLE="background-color: green; color: white; font-size: 72" >

<TR><TD ALIGN=CENTER>
<INPUT TYPE="BUTTON" NAME="btnMenu" VALUE="&nbsp; MENU &nbsp;"    OnClick="parent.location='menu.cfm'"  STYLE="background-color: green; color: white; font-size: 64 " > &nbsp; &nbsp; &nbsp;
<INPUT TYPE="BUTTON" NAME="btnPlan" VALUE="&nbsp; Plan: #this.PlanId# &nbsp;"    OnClick="fnGoPlan();"  Style="font-size: 64 " >  &nbsp; &nbsp; &nbsp;
<INPUT TYPE="BUTTON" NAME="btnFlight" VALUE="&nbsp; Flight: #this.FlightId# &nbsp;"  OnClick="fnGoFlight();"  Style="font-size: 64 " > 


<TR><TD ALIGN=CENTER>
<INPUT TYPE="BUTTON" NAME="btnWeight" VALUE="W,TBI" OnClick="fnWeightFocus();" Style="font-size: 64 " >  &nbsp; &nbsp; &nbsp;
<INPUT TYPE="BUTTON" NAME="btnStartup" VALUE="&nbsp; Start  &nbsp;" OnClick="fnStartupFocus();" Style="font-size: 64 " >   &nbsp; &nbsp; &nbsp;
<INPUT TYPE="BUTTON" NAME="btnBrief" VALUE="&nbsp; BRIEF &nbsp;" OnClick="fnBriefFocus();" Style="font-size: 64 " >  &nbsp; &nbsp; &nbsp;
<INPUT TYPE="BUTTON" NAME="btnATIS" VALUE="ATIS" OnClick="fnATISFocus();" Style="font-size: 64 " >  
<TR><TD ALIGN=CENTER>
<INPUT TYPE="BUTTON" Style="text-align: center; background-color: RED" VALUE="&nbsp;&nbsp;&nbsp; 911 &nbsp;&nbsp;&nbsp;" OnClick="parent.location='Cessna911.htm'"  Style="font-size: 48 " >  &nbsp; &nbsp; &nbsp;
<INPUT TYPE="BUTTON" NAME="btnCircuit" VALUE="&nbsp; Circuit &nbsp;" OnClick="fnCircuitFocus();" Style="font-size: 48 " >  &nbsp; &nbsp; &nbsp;
<INPUT TYPE="BUTTON" NAME="btnSpeeds" VALUE="&nbsp; Speeds &nbsp;" OnClick="fnSpeedsFocus();"  Style="font-size: 48 " >
...
<TABLE bgcolor="##EEDDDD" BORDER=0 CELLPADDING=1 CELLSPACING=0 WIDTH=100%>
  ...
  <TR><TD CLASS=ListNum>
      <TD CLASS=ListItemTime COLSPAN=2 STYLE="Padding-bottom: 10 " ALIGN=RIGHT>TACH:
...
<TABLE>
  ...
  <TR>  
    <TD VALIGN=TOP CLASS=SecHeading COLSPAN=3>PASSENGER CONCISE BRIEF

  <TR><TD>
   <TABLE>
   <TR><TD CLASS=ListNum><TD CLASS=ListItem COLSPAN=2><FONT COLOR=GREY>
       No Smoking<BR>
   ...
   <TR>  
    <TD VALIGN=TOP CLASS=SecHeading COLSPAN=3>PASSENGER BRIEF   
 ...
 <table BGCOLLOR=##EEDDDD BORDER=0>
   <TR>  
    <TD VALIGN=TOP CLASS=SecHeading COLSPAN=3>CREW PRE-TAKE OFF BRIEF
	 <TR>
	   <TD>			
...
<TABLE bgcolor="##FFFFEE" BORDER=0 CELLPADDING=1 CELLSPACING=0 WIDTH=100%>
        ...
        <TD>&nbsp;
			   ...
			   <TR>
			     ...
			     <TD CLASS=ListTask STYLE="Border: none" STYLE="Padding-bottom: 7 ">
			       	...
			       	<INPUT TYPE=TEXT NAME="flWindSpeed" VALUE="#this.flWindSpeed#" SIZE=3 MAXLENGTH=3  OnChange="fnXWind()"> Knots
		 ...
		 <TR>
             ...
             <INPUT TYPE="BUTTON" VALUE="X-Wind:" STYLE="font-size: 36" OnClick="fnXWind()">
        
 
		     <TD CLASS=ListTask STYLE="Border: none" STYLE="Padding-bottom: 7 " COLSPAN=3>
            
             <INPUT TYPE=TEXT NAME="flXWind" VALUE="" SIZE=2 MAXLENGTH=2 DISABLED > Knots &nbsp;
      ...
      <TR>
        <TD>&nbsp;
		 ...
		 <TR>
            ...
            <INPUT TYPE="BUTTON" VALUE="Humidity:" STYLE="font-size: 36" OnClick="fnHumidity()">
            <!--- Humidity:  --->
            <TD COLSPAN=3>
            <INPUT TYPE=TEXT NAME="flHumidity" VALUE="" STYLE="text-align: right; background-color: ##EEEEEE" SIZE=3 MAXLENGTH=3  READONLY DISABLED>
			     ...
			     <TD CLASS=ListTask STYLE="Border: none" STYLE="Padding-bottom: 7 ">
				           ...
				           <OPTION VALUE="31" <CFIF this.flPressureA EQ 31 > SELECTED </CFIF> >31</OPTION>
			   				...
			   				<SELECT NAME="flPressureB">
			   				   <CFLOOP INDEX=n FROM=1 TO=99>
			   				   		<OPTION VALUE="#n#" <CFIF this.flPressureB EQ n > SELECTED </CFIF> >#Right("00" & n,2)#</OPTION>
			   				   </CFLOOP>
				        </SELECT>
       ...
       <TR>
        <TD>&nbsp;    			 
		    <TR>
		       ...
		       <TD CLASS=ListTask STYLE="Border: none" STYLE="Padding-bottom: 7 ">       
			       	<INPUT TYPE=TEXT NAME="flTaxiProgression" VALUE="" SIZE=20 MAXLENGTH=20>
	      ...
	      <TR>
			     ...
			     <TD CLASS=ListTask STYLE="Border: none" STYLE="Padding-bottom: 7 ">
	     		   	  ...
	     		   	  <SELECT NAME="flSquawk1">
	     			   	   <CFLOOP INDEX=n FROM=0 TO=7>
			   				   		<OPTION VALUE="#n#" <CFIF this.flSquawk1 EQ n > SELECTED </CFIF> >#n#</OPTION>
			   				   </CFLOOP>
			   		   </SELECT>
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;
	     		   		...
	     		   		<SELECT NAME="flSquawk2">
	     			   	   <CFLOOP INDEX=n FROM=0 TO=7>
			   				   		<OPTION VALUE="#n#" <CFIF this.flSquawk2 EQ n > SELECTED </CFIF> >#n#</OPTION>
			   				   </CFLOOP>
			   		   </SELECT>
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;
	     		   		...
	     		   		<SELECT NAME="flSquawk3">
	     			   	   <CFLOOP INDEX=n FROM=0 TO=7>
			   				   		<OPTION VALUE="#n#" <CFIF this.flSquawk3 EQ n > SELECTED </CFIF> >#n#</OPTION>
			   				   </CFLOOP>
			   		   </SELECT>
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;
	     			   	...
	     			   	<SELECT NAME="flSquawk4">
	     			   	   <CFLOOP INDEX=n FROM=0 TO=7>
			   				   		<OPTION VALUE="#n#" <CFIF this.flSquawk4 EQ n > SELECTED </CFIF> >#n#</OPTION>
			   				   </CFLOOP>
			   		   </SELECT>
		  ...
		  <TR STYLE="Display: none">
		     <TD CLASS=ListNum>
		      <TD CLASS=ListItem STYLE="Border: none" STYLE="Padding-bottom: 7 "><FONT COLOR=GREY><B>Forward Ground Speed</B>
			    <TD CLASS=ListTask STYLE="Border: none" STYLE="Padding-bottom: 7 ">
	 						<INPUT size="2" name="cwresultloss" readonly DISABLED><FONT COLOR=GREY> Knots
			       	<INPUT size=5 name=g value=loss DISABLED>  
		 <!--- <TR>
		     <TD CLASS=ListNum>
...
<TABLE bgcolor="##EEDDDD" BORDER=0 CELLPADDING=1 CELLSPACING=0 WIDTH=100%>
	<TR>
      <TD COLSPAN=1 CLASS=ListItemTime STYLE="Padding-bottom: 10;" ALIGN=RIGHT>HH:MM
      <TD COLSPAN=3 CLASS=ListItemTime STYLE="Padding-right: 50;" ALIGN=RIGHT>                     
        <INPUT TYPE="TEXT" SIZE=2 NAME="flDepartureHH" VALUE="#this.DepartureHH#" STYLE="Text-ALign: right; font-size: 126">:
        <INPUT TYPE="TEXT" SIZE=2 NAME="flDepartureMM" VALUE="#this.DepartureMM#" STYLE="font-size: 126">
        <INPUT TYPE="BUTTON" STYLE="font-size: 126" NAME="btnDepart" VALUE=" DEPART " OnClick="fnDepart();">

	  <TR><TD CLASS=ListNum>7<TD CLASS=ListItemPlan>Flight Plan      <TD CLASS=ListTaskPlan>OPEN
        <TR><TD>&nbsp;	
            <TD CLASS=ListTaskPlan COLSPAN=3 ALIGN=RIGHT>
               <INPUT TYPE="BUTTON" STYLE="font-size: 72" NAME="btnTakeOff" VALUE="T.O. &uarr;" OnClick="fnTakeOffFocus();">
...
<TABLE bgcolor="##EEDDDD" BORDER=0 CELLPADDING=1 CELLSPACING=0 WIDTH=100%>
 <TR>	    
	 <TD CLASS=SecHeading COLSPAN=3>NORMAL TAKEOFF 
	     ...
	     <TR><TD CLASS=ListNum>2<TD CLASS=ListItem>Oil, Temp          <TD CLASS=ListTask>CHK Green
	     <TR><TD CLASS=ListNum>3<TD CLASS=ListItem>GO 4 Flight        <TD CLASS=ListTask>GO, NO-GO
	     <TR><TD CLASS=ListNum>4<TD CLASS=ListItem>Throttle           <TD CLASS=ListTask>Full OPEN 
		   <TR><TD CLASS=ListNum>5<TD CLASS=ListItem>Airspeed           <TD CLASS=ListTask>"ALIVE"
		   <TR><TD CLASS=ListNum>6<TD CLASS=ListItem>Gauges             <TD CLASS=ListTask>CHK 	     
	     <TR><TD CLASS=ListNum>7<TD CLASS=ListItem>Rotate                                         <TD CLASS=ListTask>55-60 KIAS 
 ...
 <!--- <TR>	    
	 <TD CLASS=SecHeading2 COLSPAN=3>TAKEOFF: SOFT-FIELD  
	     <TR><TD CLASS=ListNum>1<TD CLASS=ListItem>Flaps                       <TD CLASS=ListTask>10&deg; 
	     <TR><TD CLASS=ListNum>2<TD CLASS=ListItem>Accel. in ground eff. 
	     <TR><TD CLASS=ListNum>3a<TD CLASS=ListItem>Climb Out/50 ft. obst       <TD CLASS=ListTask>Vx 55 KIAS SL 
	     <TR><TD CLASS=ListNum>3b<TD CLASS=ListItem>Climb Out/No obst           <TD CLASS=ListTask>Vy 73 KIAS SL
	     <TR><TD CLASS=ListNum>4<TD CLASS=ListItem>Flaps                       <TD CLASS=ListTask>RETRACT
	     <TR><TD>&nbsp;
	     
 <TR>	    
	 <TD CLASS=SecHeading2 COLSPAN=3>TAKEOFF: SHORT-FIELD  
	     <TR><TD CLASS=ListNum>1a<TD CLASS=ListItem>Flaps Obstacle                <TD CLASS=ListTask>UP
	     <TR><TD CLASS=ListNum>1b<TD CLASS=ListItem>Flaps No Obstacle                <TD CLASS=ListTask>DN 
	     <TR><TD CLASS=ListNum>2<TD CLASS=ListItem>Carburetor Heat                  <TD CLASS=ListTask>COLD 
	     <TR><TD CLASS=ListNum>3<TD CLASS=ListItem>Brakes                  <TD CLASS=ListTask>APPLY 
	     <TR><TD CLASS=ListNum>4<TD CLASS=ListItem>Throttle                  <TD CLASS=ListTask>Full OPEN 
	     <TR><TD CLASS=ListNum>5<TD CLASS=ListItem>Engine Instruments                  <TD CLASS=ListTask>CHK 
	     <TR><TD CLASS=ListNum>6<TD CLASS=ListItem>Brakes                  <TD CLASS=ListTask>RELEASE 
	     <TR><TD CLASS=ListNum>7<TD CLASS=ListItem>Rotate                  <TD CLASS=ListTask>55 KIAS 
	     <TR><TD CLASS=ListNum>8<TD CLASS=ListItem>Climb                  <TD CLASS=ListTask>Vx till obst. clear  
	     <TR><TD CLASS=ListNum><TD CLASS=ListItem Colspan=2><FONT COLOR=Grey>Best Angle: 59 KIAS @ sea level<BR>61 KIAS @ 10,000 ft. 
		       <TR><TD>&nbsp;
	   ...
	   <TABLE>
	     <TR>
	      <TD ALIGN=CENTER COLSPAN=2>
	       <IMG SRC="C172Circuit.png"  STYLE="WIDTH: 480; Height: AUto" >
	   </TABLE>
	</DIV>   
</CFFUNCTION>
       ...
       <TR>
        <TD>
 		<TABLE BORDER=0 ALIGN=LEFT>
		  ...
		  <TR><TD CLASS=SecHeading COLSPAN=2>V SPEEDS  
		      <TD CLASS=SecHeading >KIAS
		      <TD CLASS=SecHeading >MPH
		      <TD CLASS=SecHeading >KIAS
          <TD CLASS=SecHeading COLSPAN=1>
			<TR><TD CLASS=ListNum>Stall (Flaps DN)<TD CLASS=ListItem>Vso           	<TD CLASS=ListSpeed>41       <TD CLASS=ListSpeed>49			<TD CLASS=ListSpeed>35    <TD CLASS=ListItem>Vso            			                                                                                     
			<TR><TD CLASS=ListNum>Stall (Flaps UP)<TD CLASS=ListItem>Vs            	<TD CLASS=ListSpeed>47       <TD CLASS=ListSpeed>57			<TD CLASS=ListSpeed>40    <TD CLASS=ListItem>Vs             			                                                                                     
			<TR><TD CLASS=ListNum>Rotate<TD CLASS=ListItem>Vr             					<TD CLASS=ListSpeed>55-65    <TD CLASS=ListSpeed>60			<TD CLASS=ListSpeed>      <TD CLASS=ListItem>Vr             			                                                                                    
			<TR><TD CLASS=ListNum>Best Angle<TD CLASS=ListItem>Vx (sea level) 			<TD CLASS=ListSpeed>59       <TD CLASS=ListSpeed>75			<TD CLASS=ListSpeed>55    <TD CLASS=ListItem>(SL) Vx  				                                                                                      
			<TR><TD CLASS=ListNum>Best Angle<TD CLASS=ListItem>Vx (10,000 ft.)			<TD CLASS=ListSpeed>61       <TD CLASS=ListSpeed>  			<TD CLASS=ListSpeed>      <TD CLASS=ListItem>(10K) Vx 		                                                                                              
			<TR><TD CLASS=ListNum>Best Rate<TD CLASS=ListItem>Vy (sea level) 				<TD CLASS=ListSpeed>73       <TD CLASS=ListSpeed>90			<TD CLASS=ListSpeed>67    <TD CLASS=ListItem>(SL) Vy
			<TR><TD CLASS=ListNum>Best Rate<TD CLASS=ListItem>Vy (2,000 ft.)				<TD CLASS=ListSpeed>         <TD CLASS=ListSpeed>		  	<TD CLASS=ListSpeed>      <TD CLASS=ListItem>(2K) Vy 	    	       	    	                                                                                  
			<TR><TD CLASS=ListNum>Best Rate<TD CLASS=ListItem>Vy (10,000 ft.)				<TD CLASS=ListSpeed>68       <TD CLASS=ListSpeed>79			<TD CLASS=ListSpeed>      <TD CLASS=ListItem>(10K) Vy 				                                                                                      
			<TR><TD CLASS=ListNum>Max Flaps Extnd<TD CLASS=ListItem>Vfe            	<TD CLASS=ListSpeed>85       <TD CLASS=ListSpeed>100		<TD CLASS=ListSpeed>85    <TD CLASS=ListItem>Vfe            			                                                                                    
			<TR><TD CLASS=ListNum>Never Operate<TD CLASS=ListItem>Vno            		<TD CLASS=ListSpeed>128      <TD CLASS=ListSpeed>145		<TD CLASS=ListSpeed>      <TD CLASS=ListItem>Vno            			                                                                                    
			<TR><TD CLASS=ListNum>Never Exceed<TD CLASS=ListItem>Vne          			<TD CLASS=ListSpeed>160      <TD CLASS=ListSpeed>182		<TD CLASS=ListSpeed>149   <TD CLASS=ListItem>Vne          				                                                                                    
			<TR><TD CLASS=ListNum>Best Man.<TD CLASS=ListItem>Va (2300 lbs)					<TD CLASS=ListSpeed>97       <TD CLASS=ListSpeed>112		<TD CLASS=ListSpeed>104   <TD CLASS=ListItem NOWRAP>(1640 lbs) Va                                                                                  
			<TR><TD CLASS=ListNum>Best Man.<TD CLASS=ListItem>Va (1950 lbs)					<TD CLASS=ListSpeed>89       <TD CLASS=ListSpeed>		  	<TD CLASS=ListSpeed>      <TD CLASS=ListItem>( lbs)	Va 					                                                                                    
			<TR><TD CLASS=ListNum>Best Man.<TD CLASS=ListItem>Va (1600 lbs)					<TD CLASS=ListSpeed>80       <TD CLASS=ListSpeed>		  	<TD CLASS=ListSpeed>      <TD CLASS=ListItem>( lbs)	Va 				                                                                                      
			<TR><TD CLASS=ListNum>Best Glide<TD CLASS=ListItem>(flaps UP)		        <TD CLASS=ListSpeed>65       <TD CLASS=ListSpeed>		   	<TD CLASS=ListSpeed>60    <TD CLASS=ListItem>Best Glide		                                                                                        
			<TR><TD CLASS=ListNum>Best Glide<TD CLASS=ListItem> (flaps DN)		      <TD CLASS=ListSpeed>60       <TD CLASS=ListSpeed>	  		<TD CLASS=ListSpeed>      <TD CLASS=ListItem>Best Glide	                                                                                          
			<TR><TD CLASS=ListNum>Max X-Wind<TD CLASS=ListItem>Demonstrated		    	<TD CLASS=ListSpeed>15       <TD CLASS=ListSpeed>	  		<TD CLASS=ListSpeed>12    <TD CLASS=ListItem>X-Wind       	   		                                                                              
			<TR><TD CLASS=ListNum>Approach<TD CLASS=ListItem> (Flaps UP)			      <TD CLASS=ListSpeed>60-70    <TD CLASS=ListSpeed>	  		<TD CLASS=ListSpeed>      <TD CLASS=ListItem>Approach	      	                                                                              
			<TR><TD CLASS=ListNum>Approach<TD CLASS=ListItem> (Flaps DN)		      	<TD CLASS=ListSpeed>55-65    <TD CLASS=ListSpeed>	  		<TD CLASS=ListSpeed>      <TD CLASS=ListItem>Approach		                                                                                        
		...
		<TABLE BORDER=0>
		 <TR>	    
			 <TD CLASS=SecHeading COLSPAN=3>AIRCRAFT SPECIFICATIONS
			      <TR><TD CLASS=ListItem>Type                      <TD CLASS=ListTask>Cessna 172M 
			      <TR><TD CLASS=ListItem>Takeoff Weight           <TD CLASS=ListTask> 2300 lbs. 
			      <TR><TD CLASS=ListItem>Usable Fuel               <TD CLASS=ListTask>38 gallons (172M)  48 gallons (Long Range) 
			      <TR><TD CLASS=ListItem>Recommended oil          <TD CLASS=ListTask>15W-50/20W-50 (all temps.) 
			      <TR><TD CLASS=ListItem>Oil Capacity: 			<TD CLASS=ListTask>8 quarts (sump) &ndash; 9 quarts (total) 
			      <TR><TD CLASS=ListItem>Engine Type: 			<TD CLASS=ListTask>O-320-H2AD 
			      <TR><TD CLASS=ListItem>Maximum Power: 		<TD CLASS=ListTask>160 BHP 
  		      <TR><TD CLASS=ListItem>Electrical System: 			<TD CLASS=ListTask>28V DC, 60-amp alt., 14V 24 amp-hr. battery 
			      <TR><TD CLASS=ListItem>Proper tire inflation: 	<TD CLASS=ListTask>31 PSI (nose wheel), 29 PSI (main wheels) 
			      <TR><TD CLASS=ListItem>Wingspan: 					<TD CLASS=ListTask>36&rsquo; 1&rdquo; Length: 27&rsquo; 2&rdquo; 
			      <TR><TD CLASS=ListItem>Height:					 <TD CLASS=ListTask>8&rsquo; 11&rdquo; Prop. diameter: 75&rdquo; 
			      <TR><TD CLASS=ListItem>Approved Fuel:            <TD CLASS=ListTask>100, 100LL 
			      <TR><TD CLASS=ListItem>FSS: &ndash;               <TD CLASS=ListTask>1-888-WX-BRIEF<BR>1-888-992-7433
		</TABLE>
...
<TABLE bgcolor=##EEDDDD BORDER=0 CELLPADDING=1 CELLSPACING=0 WIDTH=100%>
	 <TR> 
	    <TD CLASS=ListItemTime COLSPAN=1 STYLE="Padding-bottom: 10 " ALIGN=RIGHT>HH:MM
	 	  <TD CLASS=ListItemTime COLSPAN=3 STYLE="Padding-right: 50 " ALIGN=RIGHT>
          <INPUT TYPE="TEXT" SIZE=2 NAME="flArrivalHH" VALUE="#this.ArrivalHH#" STYLE="Text-ALign: right; font-size: 126">:
          <INPUT TYPE="TEXT" SIZE=2 NAME="flArrivalMM" VALUE="#this.ArrivalMM#" STYLE="font-size: 126">
          <INPUT TYPE="BUTTON" NAME="btnArrive" STYLE="font-size: 126" VALUE=" ARRIVE " OnClick="fnArrive();">
 ...
 <TR>	    
  ...
  <TR><TD>&nbsp;
   ...
   <TR><TD CLASS=ListNum>
       ...
       STYLE="Text-ALign: right">
	  <TR><TD CLASS=ListNum>
	  <TD CLASS=ListItemTime COLSPAN=2 STYLE="Padding-bottom: 10 " ALIGN=RIGHT><B>TACH:	
...
<TABLE bgcolor=White BORDER=0 CELLPADDING=1 CELLSPACING=0 WIDTH=100%>
 <TR>
	 <TD VALIGN=TOP CLASS=SecHeading COLSPAN=3>WEIGHT
 			 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5">a
 			     <TD CLASS=ListTask><B>Basic Empty W. (BEW):  
 				 	 <TD CLASS=ListItem ALIGN=RIGHT>	     
  			      <INPUT TYPE=TEXT NAME="WBBEW" VALUE="#this.WBBEW#" SIZE=6 MAXLENGTH=12 STYLE="text-align: right" > <FONT COLOR=##DDDDDD>lbs			  

		 	 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5">b
		 	     <TD CLASS=ListTask><B>Pilot
	 				 	 <TD CLASS=ListItem ALIGN=RIGHT>		 	 
		 	   			<INPUT TYPE=TEXT NAME="WBPilot" VALUE="#this.WBPilot#" SIZE=3 MAXLENGTH=12 STYLE="text-align: right" > <FONT COLOR=##DDDDDD>lbs
		 	   			 	                                                         
		 	 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5">c
		 	     <TD CLASS=ListTask><B>Front Passenger  
 				 	 <TD CLASS=ListItem ALIGN=RIGHT>
		 	 		 	  <INPUT TYPE=TEXT NAME="WBFrontPassenger" VALUE="#this.WBFrontPassenger#" SIZE=3 MAXLENGTH=12 STYLE="text-align: right" > <FONT COLOR=##DDDDDD>lbs                                             <TD CLASS=ListItem>&nbsp;		
		 	 		 	   
		 	 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5">d
		 	     <TD CLASS=ListTask><B>Rear Passengers<BR><FONT COLOR=##DDDDDD>_______ + _______     
	 				 	 <TD CLASS=ListItem ALIGN=RIGHT>	
			 	  	  <INPUT TYPE=TEXT NAME="WBRearPassengers" VALUE="#this.WBRearPassengers#" SIZE=3 MAXLENGTH=12 STYLE="text-align: right" > <FONT COLOR=##DDDDDD>lbs 	 	         
		 	 
		 	 
		 	 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5">e
		 	     <TD CLASS=ListTask><B>Cargo
		 	 	 	 <TD CLASS=ListItem ALIGN=RIGHT>
		 	       <INPUT TYPE=TEXT NAME="WBCargo" VALUE="#this.WBCargo#" SIZE=3 MAXLENGTH=12 STYLE="text-align: right" > 
		 	         <FONT COLOR=##DDDDDD>lbs 	
		 	    
		 	 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5">f
		 	     <TD CLASS=ListTask align=right><B>ZERO FUEL W.<FONT COLOR=##DDDDDD> ( a:e )
		 	 	 	 <TD CLASS=ListItem ALIGN=RIGHT>
		 	       <INPUT TYPE=TEXT NAME="WBZeroFuelWeight" VALUE="#this.WBZeroFuelWeight#" SIZE=4 MAXLENGTH=12 STYLE="text-align: right; border-top: 1pt solid black" >
		 	          <FONT COLOR=##DDDDDD>lbs 	 

		 	       		 	                                       
		 	 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5">h
		 	     <TD CLASS=ListTask NOWRAP ><B>Fuel<BR><FONT COLOR=##DDDDDD> 
		 	       <INPUT TYPE=TEXT NAME="WBFuelQuantity" SIZE=2 MAXLENGTH=12 STYLE="text-align: right;" VALUE="38"> 
		 	       
		 	          <CFIF this.WBFuelWeightPerUnit EQ 0>
		 	             <CFSET  this.WBFuelWeightPerUnit = 6 >
		 	          </CFIF>
		 	       
		 	          Gallons x <INPUT TYPE=TEXT NAME="WBFuelWeightPerUnit" VALUE="#this.WBFuelWeightPerUnit#" SIZE=2 MAXLENGTH=12 STYLE="text-align: right;" > lbs	             
		 	 	 	 <TD CLASS=ListItem ALIGN=RIGHT>	
		 		       <INPUT TYPE=TEXT NAME="WBFuelWeight" VALUE="#this.WBFuelWeight#" SIZE=4 MAXLENGTH=12 STYLE="text-align: right;" VALUE="228"> 
		 	          <FONT COLOR=##DDDDDD>lbs	 	 
		 	       		 	 
		 	 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5">i
		 	     <TD CLASS=ListTask align=right><B>A</B>ll <B>U</B>p <B>W</B>eight<FONT COLOR=##DDDDDD> ( g + h )
			 	 	 	 <TD CLASS=ListItem ALIGN=RIGHT>	
		 		       <INPUT TYPE=TEXT NAME="WBAllUpWeight" VALUE="#this.WBAllUpWeight#" SIZE=5 MAXLENGTH=12 STYLE="text-align: right;" VALUE=""> 
		 	          <FONT COLOR=##DDDDDD>lbs	
		 	 
		 	 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5">j<TD CLASS=ListTask NOWRAP>Pre-Takeoff Burn:<BR>
		 	      <FONT COLOR=##DDDDDD>( 1.1 gallons ) x [  6.0 lbs  ]                                                                               
		 	 	 	 <TD CLASS=ListItem ALIGN=RIGHT>	
		 		       <INPUT TYPE=TEXT NAME="WBPreTakeOffBurn" VALUE="#this.WBPreTakeOffBurn#" SIZE=3 MAXLENGTH=12 STYLE="text-align: right;" VALUE="6.6"> 
		 	          <FONT COLOR=##DDDDDD>lbs	
		 	         
		 	         
		 	 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5">k
		 	     <TD CLASS=ListTask align=right><B>T</B>ake<B>O</B>ff WEIGHT<FONT COLOR=##DDDDDD> ( i - j )
		 	 	 	 <TD CLASS=ListItem ALIGN=RIGHT>	
		 		       <INPUT TYPE=TEXT NAME="WBTakeOffWeight" VALUE="#this.WBTakeOffWeight#" SIZE=5 MAXLENGTH=12 STYLE="text-align: right;  border-top: 1pt solid black" >
		 	          <FONT COLOR=##DDDDDD>lbs	

       <TR><TD COLSPAN=3 ALIGN=RIGHT>&nbsp; 
         <INPUT TYPE=Button NAME="btnWBCalc" VALUE="Calculate" OnClick="fnWBCalc()">
         
  <SCRIPT LANGUAGE="Javascript">
    function fnWBCalc() {
       frm = document.forms[0];
       
       frm.WBZeroFuelWeight.value = parseFloat(frm.WBBEW.value) + parseFloat(frm.WBPilot.value) + parseFloat(frm.WBFrontPassenger.value) + parseFloat(frm.WBRearPassengers.value) + parseFloat(frm.WBCargo.value);
       frm.WBFuelWeight.value = frm.WBFuelQuantity.value * frm.WBFuelWeightPerUnit.value;
       frm.WBFuelWeight.value = roundNumber(frm.WBFuelWeight.value, 2);
       
       frm.WBAllUpWeight.value =   parseFloat(frm.WBZeroFuelWeight.value) +  parseFloat(frm.WBFuelWeight.value);
       
       frm.WBTakeOffWeight.value =   parseFloat(frm.WBAllUpWeight.value) -  parseFloat(frm.WBPreTakeOffBurn.value);
...
<TR>
 <TD VALIGN=TOP CLASS=SecHeading COLSPAN=3>TBI
 			 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5"><TD CLASS=ListTask><B>Next Service:  <TD CLASS=ListItem >&nbsp;
 			      <INPUT TYPE=TEXT NAME="flTBINextService" VALUE= "#this.flTBINextService#" SIZE=10 MAXLENGTH=12 STYLE="text-align: right"> <FONT COLOR=##DDDDDD>hours
 			       			 
 			 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5"><TD CLASS=ListTask><B>Last J. Log Entry:    <TD CLASS=ListItem >&nbsp;
  			    <INPUT TYPE=TEXT NAME="flTBILastService" VALUE= "#this.flTBILastService#" SIZE=10 MAXLENGTH=12 STYLE="text-align: right"> <FONT COLOR=##DDDDDD>hours
  			    
 			 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5"><TD CLASS=ListTask><B>Recent Hours (non-logged):    <TD CLASS=ListItem >&nbsp;
 			      <INPUT TYPE=TEXT NAME="flTBIRecentHours" VALUE= "#this.flTBIRecentHours#" SIZE=10 MAXLENGTH=12 STYLE="text-align: right"> <FONT COLOR=##DDDDDD>hours
 			 
       <TR><TD>                         
 			 <TR><TD CLASS=ListNum STYLE="Padding-Bottom: 5"><TD CLASS=ListTask align=right><b>TBI:</b>    <TD CLASS=ListItem >&nbsp;  
 			  			      <INPUT TYPE=TEXT NAME="flTBI" VALUE= "#this.flTBI#" SIZE=5 MAXLENGTH=12 STYLE="text-align: right"> <FONT COLOR=##DDDDDD>hours         
 			  			                    
       <TR><TD COLSPAN=3 ALIGN=RIGHT>&nbsp; 
         <INPUT TYPE=Button NAME="btnTBICalc" VALUE="TBI Calculate" OnClick="fnTBICalc()">
...
<CFFUNCTION NAME="fnCruise" OUTPUT=TRUE>
  ...
  <TR>
       ...
       <INPUT TYPE="BUTTON" NAME="btnPlanEmbedded" VALUE="Plan: #this.PlanId#"    OnClick="fnGoPlan();">
